...
public class Song
{
	...
	/*
	 * vergleicht 2 Songs. Wenn der erste song größer ist als der zweite wird ein positiver wert zurückgegeben,
	 * ansonsten wird ein negativer zurückgegeben.
	 * @param s - der zu vergleichende Song
	...
	public void setSong(String song) {
		...
		int a = song.indexOf(';');
		titel = song.substring(0, a);
		album = song.substring(a + 1, song.indexOf(';', a + 1));
		a = song.indexOf(';', a + 1);
		interpret = song.substring(a + 1, song.indexOf(';', a + 1));
		a = song.indexOf(';', a + 1);
		erscheinungsjahr = Integer.valueOf(song.substring(a + 1));
	}
